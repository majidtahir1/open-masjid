...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "carousel_slides" ALTER COLUMN "background_theme" SET DATA TYPE text;
  ALTER TABLE "carousel_slides" ALTER COLUMN "background_theme" SET DEFAULT 'clean'::text;
