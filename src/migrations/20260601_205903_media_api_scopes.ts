...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  // Text-swap (matches 20260601_200031_api_scopes_capability_surface) rather
  // than `ALTER TYPE ... ADD VALUE`, which Postgres restricts inside the
  // transaction Payload wraps migrations in. Keep the value list in sync with
  // Users.apiScopes options.
