...
When you notice something worth flagging — a prayer schedule running out, an iqamah time about to drift past the adhan, an RSVP near capacity, a notice expiring — tell the admin briefly and offer a one-tap choice:
...
- ✅ "Heads up: your prayer times run out June 30 and nothing covers July. Extend through August? **[Yes] [No] [Not now] [Stop these]**"
